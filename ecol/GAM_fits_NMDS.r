...
pdf("GAM_fits/NMDS_neo_occurence_by_climate_1Kmin_GAM.pdf", width = 22, height = 12)
grid.arrange(p.site,p.dur_inf,p.tmin,p.MAT,p.tmax,p.ppt,nrow = 2)
dev.off()

pdf("GAM_fits/NMDS_neo_occurence_by_disease_severity_1Kmin_GAM.pdf", width = 22, height = 18)
...
asv_tab.gt1K.rare = readRDS(file = "intermediate_RDS/asv_tab.gt1K.rare.rds")
#NMDS
asv_tab.gt1K.rare.mds.bin = readRDS(file = "intermediate_RDS/asv_tab.gt1K.rare.mds.bin.rds")
...
scale_color_gradient(name = "DBH", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("DBH (cm)\nR2 =",signif(surf.dbh.anova$r.sq, 2),", P =", signif(surf.dbh.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "neo_fruiting", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("Neonectria fruiting (0-5)\nR2 =",signif(surf.neo_fruiting.anova$r.sq, 2),", P =", signif(surf.neo_fruiting.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "cankers", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("Cankers\nR2 =",signif(surf.cankers.anova$r.sq, 2),", P =", signif(surf.cankers.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "tarry_spots", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("Tarry spots\nR2 =",signif(surf.tarry_spots.anova$r.sq, 2),", P =", signif(surf.tarry_spots.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "wax", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("Wax (0-5)\nR2 =",signif(surf.wax.anova$r.sq, 2),", P =", signif(surf.wax.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "xylococcus", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("Xylococcus\nR2 =",signif(surf.xylococcus.anova$r.sq, 2),", P =", signif(surf.xylococcus.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "tree_cond", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("Tree condition (0-5)\nR2 =",signif(surf.tree_cond.anova$r.sq, 2),", P =", signif(surf.tree_cond.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "dur_inf", low = "light grey", high = "black", limits = c(5,70), breaks = c(10,30,50,70)) +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("Infection duration (yrs)\nR2 =",signif(surf.dur_inf.anova$r.sq, 2),", P =", signif(surf.dur_inf.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "tmax", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("Average maximum annual temperature\nR2 =",signif(surf.tmax.anova$r.sq, 2),", P =", signif(surf.tmax.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "MAT", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("Mean annual temperature\nR2 =",signif(surf.MAT.anova$r.sq, 2),", P =", signif(surf.MAT.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "tmin", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("Average minimum annual temperature\nR2 =",signif(surf.tmin.anova$r.sq, 2),", P =", signif(surf.tmin.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "ppt", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI"), guide = F) +
labs(title = paste("Average annual precipitation (cm)\nR2 =",signif(surf.ppt.anova$r.sq, 2),", P =", signif(surf.ppt.anova$s.pv,2) ), x = ".mds.bin1", y = ".mds.bin2")
...
scale_color_gradient(name = "ppt", low = "light grey", high = "black") +
scale_fill_brewer(palette = "Paired", name = "Site", labels = c("ADS1" = "NY south", "ADN1" ="NY north", "MEN1" = "ME north", "MES1" = "ME south", "CW1" = "NH", "TSP1" = "PA", "ASH2" = "NC", "GK1j" = "WV", "MI1" = "MI", "WF1" = "WI")) +
labs(title = "Sites and\nneonectria occurence", x = ".mds.bin1", y = ".mds.bin2") +
guides(fill = guide_legend(override.aes=list(shape=21,size=3)), shape = guide_legend(override.aes=list(size=3)))


pdf("GAM_fits/NMDS.bin_neo_occurence_by_climate_1Kmin_BINARY_GAM.pdf", width = 22, height = 12)
grid.arrange(p.site,p.dur_inf,p.tmin,p.MAT,p.tmax,p.ppt,nrow = 2)
dev.off()

pdf("GAM_fits/NMDS.bin_neo_occurence_by_disease_severity_1Kmin_BINARY_GAM.pdf", width = 22, height = 18)
grid.arrange(p.site,p.dbh,p.neo_fruiting,p.wax,p.cankers,p.tarry_spots,p.xylococcus,p.tree_cond,nrow = 3)
dev.off()
...
pdf("GAM_fits/NMDS_neo_occurence_by_climate.5Kmin_GAM.pdf", width = 22, height = 12)
grid.arrange(p.site,p.dur_inf,p.tmin,p.MAT,p.tmax,p.ppt,nrow = 2)
dev.off()

pdf("GAM_fits/NMDS_neo_occurence_by_disease_severity.5Kmin_GAM.pdf", width = 22, height = 18)
grid.arrange(p.site,p.dbh,p.neo_fruiting,p.wax,p.cankers,p.tarry_spots,p.xylococcus,p.tree_cond,nrow = 3)
dev.off()
...
asv_tab.gt5K.rare = readRDS(file = "intermediate_RDS/asv_tab.gt5K.rare.rds")
#NMDS
asv_tab.gt5K.rare.mds.bin = readRDS(file = "intermediate_RDS/asv_tab.gt5K.rare.mds.bin.rds")
...
pdf("GAM_fits/NMDS.bin_neo_occurence_by_climate.5Kmin_BINARY_GAM.pdf", width = 22, height = 12)
grid.arrange(p.site,p.dur_inf,p.tmin,p.MAT,p.tmax,p.ppt,nrow = 2)
dev.off()

pdf("GAM_fits/NMDS.bin_neo_occurence_by_disease_severity.5Kmin_BINARY_GAM.pdf", width = 22, height = 18)
grid.arrange(p.site,p.dbh,p.neo_fruiting,p.wax,p.cankers,p.tarry_spots,p.xylococcus,p.tree_cond,nrow = 3)
dev.off()
